[ICcyCollateralizable]: ICcyCollateralizable.md#ICcyCollateralizable
...
[IStFees]: #IStFees
[IStFees-getFee-enum-IStFees-GetFeeType-uint256-address-]: #IStFees-getFee-enum-IStFees-GetFeeType-uint256-address-
[IStFees-getSecToken_totalExchangeFeesPaidQty--]: #IStFees-getSecToken_totalExchangeFeesPaidQty--
[IStFees-getSecToken_totalOriginatorFeesPaidQty--]: #IStFees-getSecToken_totalOriginatorFeesPaidQty--
[IStFees-getCcy_totalExchangeFeesPaid-uint256-]: #IStFees-getCcy_totalExchangeFeesPaid-uint256-
[IStFees-setFee_TokType-uint256-address-struct-StructLib-SetFeeArgs-]: #IStFees-setFee_TokType-uint256-address-struct-StructLib-SetFeeArgs-
[IStFees-setFee_CcyType-uint256-address-struct-StructLib-SetFeeArgs-]: #IStFees-setFee_CcyType-uint256-address-struct-StructLib-SetFeeArgs-
...
## <span id="IStFees"></span> `IStFees`

Controls fees by currency and token type


Fees are applied on whitelisted transfers: (global exchange fee || ledger fee) [+ batch originator fee]
Fees in addition to the amounts supplied to transferOrTrade() (i.e. transfer amounts are not inclusive of fees, they are additional)

- [`onlyOwner()`][IOwned-onlyOwner--]
- [`onlyWhenReadWrite()`][IOwned-onlyWhenReadWrite--]
- [`getFee(enum IStFees.GetFeeType feeType, uint256 typeId, address ledgerOwner)`][IStFees-getFee-enum-IStFees-GetFeeType-uint256-address-]
- [`getSecToken_totalExchangeFeesPaidQty()`][IStFees-getSecToken_totalExchangeFeesPaidQty--]
- [`getSecToken_totalOriginatorFeesPaidQty()`][IStFees-getSecToken_totalOriginatorFeesPaidQty--]
- [`getCcy_totalExchangeFeesPaid(uint256 ccyTypeId)`][IStFees-getCcy_totalExchangeFeesPaid-uint256-]
- [`setFee_TokType(uint256 tokenTypeId, address ledgerOwner, struct StructLib.SetFeeArgs feeArgs)`][IStFees-setFee_TokType-uint256-address-struct-StructLib-SetFeeArgs-]
- [`setFee_CcyType(uint256 ccyTypeId, address ledgerOwner, struct StructLib.SetFeeArgs feeArgs)`][IStFees-setFee_CcyType-uint256-address-struct-StructLib-SetFeeArgs-]
- [`setReadOnly(bool _readOnly)`][IOwned-setReadOnly-bool-]

### <span id="IStFees-getFee-enum-IStFees-GetFeeType-uint256-address-"></span> `getFee(enum IStFees.GetFeeType feeType, uint256 typeId, address ledgerOwner) → struct StructLib.SetFeeArgs` (external)

Returns the current fee structure (global or ledger fee) for the supplied token or currency type




### <span id="IStFees-getSecToken_totalExchangeFeesPaidQty--"></span> `getSecToken_totalExchangeFeesPaidQty() → uint256` (external)

Returns the total quantity of token exchange fees paid, in the contract base unit



### <span id="IStFees-getSecToken_totalOriginatorFeesPaidQty--"></span> `getSecToken_totalOriginatorFeesPaidQty() → uint256` (external)

Returns the total quantity of token originator fees paid, in the contract base unit



### <span id="IStFees-getCcy_totalExchangeFeesPaid-uint256-"></span> `getCcy_totalExchangeFeesPaid(uint256 ccyTypeId) → uint256` (external)

Returns the total amount of currency exchange fees paid, for the supplied currency



### <span id="IStFees-setFee_TokType-uint256-address-struct-StructLib-SetFeeArgs-"></span> `setFee_TokType(uint256 tokenTypeId, address ledgerOwner, struct StructLib.SetFeeArgs feeArgs)` (public)

Sets the current fee structure (global or ledger fee) for the supplied token type




### <span id="IStFees-setFee_CcyType-uint256-address-struct-StructLib-SetFeeArgs-"></span> `setFee_CcyType(uint256 ccyTypeId, address ledgerOwner, struct StructLib.SetFeeArgs feeArgs)` (public)

Sets the current fee structure (global or ledger fee) for the supplied currency type
