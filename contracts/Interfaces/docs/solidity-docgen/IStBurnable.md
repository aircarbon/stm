...
[IStBurnable]: #IStBurnable
[IStBurnable-burnTokens-address-uint256-uint256-]: #IStBurnable-burnTokens-address-uint256-uint256-
[IStBurnable-getSecToken_totalBurnedQty--]: #IStBurnable-getSecToken_totalBurnedQty--
...
## <span id="IStBurnable"></span> `IStBurnable`
...
- [`burnTokens(address ledgerOwner, uint256 tokenTypeId, uint256 burnQty)`][IStBurnable-burnTokens-address-uint256-uint256-]
- [`getSecToken_totalBurnedQty()`][IStBurnable-getSecToken_totalBurnedQty--]
- [`setReadOnly(bool _readOnly)`][IOwned-setReadOnly-bool-]

### <span id="IStBurnable-burnTokens-address-uint256-uint256-"></span> `burnTokens(address ledgerOwner, uint256 tokenTypeId, uint256 burnQty)` (external)

Burns the specified quantity of tokens, for the specified token type and ledger entry


Burn works by resizing STs (partial burn), and/or removing STs from the ledger entry (full burn)


### <span id="IStBurnable-getSecToken_totalBurnedQty--"></span> `getSecToken_totalBurnedQty() → uint256 count` (external)

Returns the sum total quantities in all tokens burned
