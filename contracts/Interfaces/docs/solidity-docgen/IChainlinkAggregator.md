...
[IChainlinkAggregator-latestAnswer--]: #IChainlinkAggregator-latestAnswer--
[IChainlinkAggregator-latestTimestamp--]: #IChainlinkAggregator-latestTimestamp--
[IChainlinkAggregator-latestRound--]: #IChainlinkAggregator-latestRound--
[IChainlinkAggregator-getAnswer-uint256-]: #IChainlinkAggregator-getAnswer-uint256-
[IChainlinkAggregator-getTimestamp-uint256-]: #IChainlinkAggregator-getTimestamp-uint256-
[IChainlinkAggregator-AnswerUpdated-int256-uint256-uint256-]: #IChainlinkAggregator-AnswerUpdated-int256-uint256-uint256-
[IChainlinkAggregator-NewRound-uint256-address-]: #IChainlinkAggregator-NewRound-uint256-address-
...
## <span id="IChainlinkAggregator"></span> `IChainlinkAggregator`

Chainlink Reference Data Contract


https://docs.chain.link/docs/using-chainlink-reference-contracts

- [`latestAnswer()`][IChainlinkAggregator-latestAnswer--]
- [`latestTimestamp()`][IChainlinkAggregator-latestTimestamp--]
- [`latestRound()`][IChainlinkAggregator-latestRound--]
- [`getAnswer(uint256 roundId)`][IChainlinkAggregator-getAnswer-uint256-]
- [`getTimestamp(uint256 roundId)`][IChainlinkAggregator-getTimestamp-uint256-]
- [`AnswerUpdated(int256 current, uint256 roundId, uint256 timestamp)`][IChainlinkAggregator-AnswerUpdated-int256-uint256-uint256-]
- [`NewRound(uint256 roundId, address startedBy)`][IChainlinkAggregator-NewRound-uint256-address-]

### <span id="IChainlinkAggregator-latestAnswer--"></span> `latestAnswer() → int256` (external)





### <span id="IChainlinkAggregator-latestTimestamp--"></span> `latestTimestamp() → uint256` (external)





### <span id="IChainlinkAggregator-latestRound--"></span> `latestRound() → uint256` (external)





### <span id="IChainlinkAggregator-getAnswer-uint256-"></span> `getAnswer(uint256 roundId) → int256` (external)





### <span id="IChainlinkAggregator-getTimestamp-uint256-"></span> `getTimestamp(uint256 roundId) → uint256` (external)





### <span id="IChainlinkAggregator-AnswerUpdated-int256-uint256-uint256-"></span> `AnswerUpdated(int256 current, uint256 roundId, uint256 timestamp)`





### <span id="IChainlinkAggregator-NewRound-uint256-address-"></span> `NewRound(uint256 roundId, address startedBy)`
