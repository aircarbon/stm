...
[IOwned]: #IOwned
[IOwned-onlyOwner--]: #IOwned-onlyOwner--
[IOwned-onlyWhenReadWrite--]: #IOwned-onlyWhenReadWrite--
[IOwned-setReadOnly-bool-]: #IOwned-setReadOnly-bool-
...
## <span id="IOwned"></span> `IOwned`

Method modifiers & read-only state
...
### <span id="IOwned-onlyOwner--"></span> `onlyOwner()`

Modifier for methods only available to the contract owner



### <span id="IOwned-onlyWhenReadWrite--"></span> `onlyWhenReadWrite()`

Modifier for methods only available when contract is not in read-only state



### <span id="IOwned-setReadOnly-bool-"></span> `setReadOnly(bool _readOnly)` (external)

Sets the contract current read-only state
