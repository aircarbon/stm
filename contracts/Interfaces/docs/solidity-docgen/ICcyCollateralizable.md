[ICcyCollateralizable]: #ICcyCollateralizable
[ICcyCollateralizable-getTotalCcyFunded-uint256-]: #ICcyCollateralizable-getTotalCcyFunded-uint256-
[ICcyCollateralizable-getTotalCcyWithdrawn-uint256-]: #ICcyCollateralizable-getTotalCcyWithdrawn-uint256-
[ICcyCollateralizable-addCcyType-string-string-uint16-]: #ICcyCollateralizable-addCcyType-string-string-uint16-
[ICcyCollateralizable-fund-uint256-int256-address-]: #ICcyCollateralizable-fund-uint256-int256-address-
[ICcyCollateralizable-withdraw-uint256-int256-address-]: #ICcyCollateralizable-withdraw-uint256-int256-address-
...
## <span id="ICcyCollateralizable"></span> `ICcyCollateralizable`

Controls collateralized currency: funding, withdrawing and adding of collateral currency types



- [`onlyOwner()`][IOwned-onlyOwner--]
- [`onlyWhenReadWrite()`][IOwned-onlyWhenReadWrite--]
- [`getTotalCcyFunded(uint256 ccyTypeId)`][ICcyCollateralizable-getTotalCcyFunded-uint256-]
- [`getTotalCcyWithdrawn(uint256 ccyTypeId)`][ICcyCollateralizable-getTotalCcyWithdrawn-uint256-]
- [`addCcyType(string name, string unit, uint16 decimals)`][ICcyCollateralizable-addCcyType-string-string-uint16-]
- [`fund(uint256 ccyTypeId, int256 amount, address ledgerOwner)`][ICcyCollateralizable-fund-uint256-int256-address-]
- [`withdraw(uint256 ccyTypeId, int256 amount, address ledgerOwner)`][ICcyCollateralizable-withdraw-uint256-int256-address-]
- [`setReadOnly(bool _readOnly)`][IOwned-setReadOnly-bool-]

### <span id="ICcyCollateralizable-getTotalCcyFunded-uint256-"></span> `getTotalCcyFunded(uint256 ccyTypeId) → uint256` (external)

Returns the total amount of funded collateralized currency for the supplied currency type



### <span id="ICcyCollateralizable-getTotalCcyWithdrawn-uint256-"></span> `getTotalCcyWithdrawn(uint256 ccyTypeId) → uint256` (external)



Returns the total global amount withdrawn for the supplied currency

### <span id="ICcyCollateralizable-addCcyType-string-string-uint16-"></span> `addCcyType(string name, string unit, uint16 decimals)` (public)
...
### <span id="ICcyCollateralizable-fund-uint256-int256-address-"></span> `fund(uint256 ccyTypeId, int256 amount, address ledgerOwner)` (public)

Funds a ledger entry with the specified amount and type of collateralized currency




### <span id="ICcyCollateralizable-withdraw-uint256-int256-address-"></span> `withdraw(uint256 ccyTypeId, int256 amount, address ledgerOwner)` (public)

Withdraws the specified amount and type of collateralized currency from the specified ledger entry
