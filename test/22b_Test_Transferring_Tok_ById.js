...
contract("StMaster", accounts => {
    ...
    // two-sided transfer
    it(`transferring tok by id - should allow two-sided exchange (A -> B) of specific STs for collateral across ledger entries, with batch originator & exchange mirrored ccy fees`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
