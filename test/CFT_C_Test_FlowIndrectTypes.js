...
contract("StMaster", accounts => {
    ...
    it(`cashflow controller - should be able to delegate-trade base indirect token types across ledger entries: two-sided, M->B by qty, A<->B by qty [, w/ exchange ccy fees per million mirrored & batch orig ccy fee]`, async () => {
        const A = accounts[global.TaddrNdx + 0], B = accounts[global.TaddrNdx + 1];
