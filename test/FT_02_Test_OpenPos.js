...
contract("StMaster", accounts => {
    ...
    it(`FT - should allow opening of a new futures position`, async () => {
    ...
    //     const A = accounts[global.TaddrNdx], B = accounts[global.TaddrNdx + 1];
    //     try {
    //         const x = await futuresHelper.openFtPos({ stm, accounts, tokTypeId: FT1.id, ledger_A: A, ledger_B: B, qty_A: -1, qty_B: +1, price: 0 });
    //     }
    ...
    //     const A = accounts[global.TaddrNdx], B = accounts[global.TaddrNdx + 1];
    //     try {
    //         const x = await futuresHelper.openFtPos({ stm, accounts, tokTypeId: FT1.id, ledger_A: A, ledger_B: B, qty_A: +1, qty_B: -1, price: -1 });
    //     }
    //     catch (ex) { assert(ex.reason == 'Bad price', `unexpected: ${ex.reason}`); return; }
    //     assert.fail('expected contract exception');
    // });
    ...
    //         const x = await futuresHelper.openFtPos({ stm, accounts, tokTypeId: FT1.id, ledger_A: A, ledger_B: B, qty_A: +1, qty_B: -1, price: bn.toString() });
    //     }
    //     catch (ex) { assert(ex.reason == 'Bad price', `unexpected: ${ex.reason}`); return; }
    //     assert.fail('expected contract exception');
    // });
