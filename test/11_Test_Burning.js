...
contract("StMaster", accounts => {
    ...
    it('burning - should allow owner to burn half a vEEU', async () => {
        await stm.mintSecTokenBatch(CONST.tokenType.UNFCCC, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
    ...
    it('burning - should allow owner to burn 1.5 vEEUs', async () => {
        await stm.mintSecTokenBatch(CONST.tokenType.UNFCCC, CONST.ktCarbon / 2, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        await stm.mintSecTokenBatch(CONST.tokenType.UNFCCC, CONST.ktCarbon / 2, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        const ledgerBefore = await stm.getLedgerEntry(accounts[global.accountNdx]);
    ...
    it('burning - should allow owner to burn multiple vEEUs of the correct type', async () => {
        ...
        await stm.mintSecTokenBatch(CONST.tokenType.UNFCCC, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        await stm.mintSecTokenBatch(CONST.tokenType.UNFCCC, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        await stm.mintSecTokenBatch(CONST.tokenType.VCS, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        await stm.mintSecTokenBatch(CONST.tokenType.VCS, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
        await stm.mintSecTokenBatch(CONST.tokenType.VCS, CONST.ktCarbon, 1, accounts[global.accountNdx], [], [], { from: accounts[0], });
