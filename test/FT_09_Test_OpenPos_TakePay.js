...
contract("StMaster", accounts => {
    ...
    before(async function () {
        ...
        shortStId = x.ledger_A.tokens.filter(p => p.tokenTypeId == usdFT.id)[0].stId;
    });
    ...
    it(`FT pos-pair take/pay - should take and pay correctly (short ITM, long OTM)`, async () => {
        const tx = await stm.takePay(usdFT.id, shortStId, 50);
